...
class r_data3:Object{
    @objc dynamic var seat_num = ""
    @objc dynamic var time_in = ""
    @objc dynamic var time_out = ""
    @objc dynamic var dish = 0
}
class hakkenData:Object{
    @objc dynamic var adult = ""
    @objc dynamic var child = ""
    @objc dynamic var memberNum = ""
    @objc dynamic var seatType = ""
    
}
class saveSetting1:Object{
...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    var adultChoise: Int = 0//大人選択
    var childChoise: Int = 0//大人選択
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        self.window?.rootViewController = hakken()
