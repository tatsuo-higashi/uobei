...
class nigiri2: UIViewController,UITextFieldDelegate,UITabBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        let leftSwipe = UISwipeGestureRecognizer(target: self, action: #selector(nigiri1.leftSwipeView(sender:)))  //Swift3
        // レフトスワイプのみ反応するようにする
        ...
        let rightSwipe = UISwipeGestureRecognizer(target: self, action: #selector(nigiri1.rightSwipeView(sender:)))  //Swift3
        // ライトスワイプのみ反応するようにする
